...
function createCard(data) {
  "".concat(arrUsers[i].login, " has url: ").concat(arrUsers[i].url, "<br>");
}
},{}],"src/lessons/01-form.js":[function(require,module,exports) {
"use strict";
...
console.log("%cWEATHER...", 'color:green; font-size:20px'); // MINE
...
var email$ = (0, _rxjs.fromEvent)(email, 'keyup').pipe((0, _operators.debounceTime)(1000), // take(2), // number of events
(0, _operators.filter)(function check(x) {
  var val = x.target.value;
  return (0, _helpers.validEmail)(val, validationEmail);
}));
email$.subscribe(function next(x) {
...
var password$ = (0, _rxjs.fromEvent)(password, 'keyup').pipe((0, _operators.debounceTime)(750), (0, _operators.filter)(function check(x) {
  var val = x.target.value;
  return (0, _helpers.validPassword)(val, validationPassword);
}));
password$.subscribe({
  next: function next(v) {
    return console.log('[PWD SUBSCRIBE] ', v);
  },
...
var button$ = (0, _rxjs.fromEvent)(button, 'click').pipe( // map((x) => {
// 	x;
// }),
...
button$.subscribe({
  next: function next(v) {
    return console.log('[BTN SUBSCRIBE] ', v);
  },
  error: function error(e) {
    return console.error(e);
  },
...
(0, _rxjs.combineLatest)([email$, password$]).subscribe(function () {
  console.log('Show Button');
  button.style.display = 'block';
});
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"node_modules/rxjs/dist/esm5/operators/index.js","../util/helpers":"src/util/helpers.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./src/lessons/01-form");
},{"./src/lessons/01-form":"src/lessons/01-form.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
