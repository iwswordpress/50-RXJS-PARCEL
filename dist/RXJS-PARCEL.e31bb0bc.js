...
},{"../internal/ajax/ajax":"node_modules/rxjs/dist/esm5/internal/ajax/ajax.js","../internal/ajax/errors":"node_modules/rxjs/dist/esm5/internal/ajax/errors.js","../internal/ajax/AjaxResponse":"node_modules/rxjs/dist/esm5/internal/ajax/AjaxResponse.js"}],"src/util/helpers.js":[function(require,module,exports) {
"use strict";
...
var button$ = (0, _rxjs.fromEvent)(button, 'click').pipe((0, _operators.switchMap)(function () {
  return (0, _ajax.ajax)(registerEmail(formData.email));
}), (0, _operators.tap)(function (jsonData) {
...
button$.subscribe({
  next: function next(x) {// console.log(`[BUTTON SUBSCRIBE] BUTTON was clicked`);
  },
...
//# sourceMappingURL=/RXJS-PARCEL.e31bb0bc.js.map